...
public:
	...
	void RetornarLlista(HDC hdc); // funció per retornar dades a alt nivell
	GUID RetornarGUID(int i); // funció per retornar una GUID concreta
	void Comprovar_Tecles(); // funció per assignar dispositius, i seleccionar-los
...
//////////////////////////////////////////////////////////////
//     Classe WinFunc, per treballar sobre la API ràpidament//
//////////////////////////////////////////////////////////////
class WinFunc
{
public:	
	void WinCls();	//	FUNCIÓ PER NETEJAR EL TEXT DE LA PANTALLA  
	void WinPrintf(int x, int y, char * buffer); // FUNCIÓ PER COL·LOCAR TEXT A LA PANTALLA
	...
	bool HandleMenu(WPARAM wparam, LPARAM lparam); // per control·lar les opcions del menú
